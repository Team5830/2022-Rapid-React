...
class GripRedBall:
    ...
    def __init__(self):
        ...
        self.__cv_cvtcolor_code = cv2.COLOR_RGB2HSV_FULL

        self.cv_cvtcolor_output = None

        self.__hsv_threshold_input = self.cv_cvtcolor_output
        self.__hsv_threshold_hue = [0.0, 77.6109195487898]
        self.__hsv_threshold_saturation = [24.636403431705318, 221.81421065095142]
        self.__hsv_threshold_value = [188.03958693425432, 255.0]
        ...
        self.__filter_contours_solidity = [82.13429485293601, 100.0]
